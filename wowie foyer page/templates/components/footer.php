            ...
            <div id="footer_container" class="row">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 icons">
                    ...
                    <ul class="list-unstyled d-flex">
                        <li class="ms-3"><a class="link-body-emphasis" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="2vw" height="2vw" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
